<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            નવી પ્રોડક્ટ ઉમેરો (Add New Product)
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/60 backdrop-blur shadow-2xl shadow-nursery-100/50 sm:rounded-3xl border-none p-8">
                <div class="text-gray-900">
                    <form method="POST" action="{{ route('products.store') }}" x-data="{ variants: @json(old('variants', [])) || [] }">
                        @csrf
