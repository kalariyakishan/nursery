                    ...
                    <div class="card-surface p-6 shadow-premium">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input name="customer_name" required value="{{ old('customer_name', $invoice->customer_name) }}"
                                       class="input-field gujarati-text font-bold text-lg @error('customer_name') border-red-500 @enderror" 
                                       placeholder="અમિતભાઈ શાહ..." type="text"/>
                                @error('customer_name')
                            ...
                            <div>
                                ...
                                <textarea name="address" 
                                          ...
                                          placeholder="મોડાસા, ગુજરાત" rows="2">{{ old('address', $invoice->address) }}</textarea>
                                @error('address')
                                    <p class="text-red-500 text-[10px] font-bold mt-1">{{ $message }}</p>
                                @enderror
                            </div>
...
@endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="card-surface p-6">
                            ...
                            <textarea name="notes" class="block w-full rounded-lg border-border-light shadow-sm focus:border-primary focus:ring-1 focus:ring-primary/20 bg-background/30 p-4 text-xs font-bold gujarati-text placeholder-text-secondary/20 resize-none" 
