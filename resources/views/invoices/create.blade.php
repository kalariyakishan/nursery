        ...
        <div class="mb-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div>
                ...
                <div class="flex items-center gap-3 mt-1">
                    ...
                    <span class="text-xs font-bold text-primary">#INV-{{ date('Ymd') }}-{{ rand(100,999) }}</span>
                </div>
            </div>
                ...
                <div class="col-span-12 lg:col-span-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="card-surface p-6 space-y-3 bg-white border-primary/10">
                            ...
                            {{-- <div class="flex justify-between items-center px-2">
                                <span class="text-text-secondary text-xs uppercase font-bold opacity-60">GST (12
                                    %)</span>
                                <span class="font-bold text-sm tracking-tight"
                                    x-text="'₹ ' + gstAmount.toLocaleString('en-IN', {minimumFractionDigits: 2})"></span>
                            </div> --}}
