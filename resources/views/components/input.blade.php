...
<div class="mb-4 relative">
    ...
    <div class="relative group">
        ...
        @endif
        <input {{ $attributes->merge(['class' => 'block w-full rounded-xl border-gray-200 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200 bg-gray-50/50 hover:bg-white text-sm py-2.5 ' . ($icon ? 'pl-9' : '')]) }}>
    </div>
</div>
