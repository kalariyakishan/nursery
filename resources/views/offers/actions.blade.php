<div class="flex justify-end gap-2">
    <a href="{{ route('offers.show', $offer) }}" class="w-9 h-9 rounded-lg border border-primary/20 text-primary inline-flex items-center justify-center hover:bg-primary/10">
